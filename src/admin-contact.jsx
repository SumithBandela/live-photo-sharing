    ...
    return (
      <div className="contact-admin-container">
        ...
        <p className="contact-admin-message">
          ...
          <a href="contactus@rashmiphotography.com" className="contact-admin-email ms-2">contactus@rashmiphotography.com</a>. We will assist you promptly to ensure your account gets back online.
        </p>
